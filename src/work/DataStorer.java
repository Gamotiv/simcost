...
public class DataStorer {
    private DataInOut dataInOut = new DataInOut(this);
...
//        this.scenario = scenario;
    ...
    public HashSet<int[]> getGraphEdges() {
        if (graphEdgeRoutes == null) {
            ...
            System.out.println("Finished generateCandidateGraph()");
        }
    ...
    public void generateCandidateGraph() {
        ...
        if (outliers.length == 0) {
            ...
            System.out.println("Outliers exist");
            String text = "";
    ...
    public String[] outliers() {
        ...
        for (Source src : sources) {
            ...
            if (!connected) {
                System.out.println(src.getLabel());
                for (double cost : constructionCosts[cell]) {
